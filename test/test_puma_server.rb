...
class TestPumaServerP < TestPumaServerBase
  ...
  def test_streaming_body
    ...
    resp_body = send_http_read_resp_body "GET / HTTP/1.0\r\nConnection: close\r\n\r\n"

    assert_equal "Hello World", resp_body
  end
