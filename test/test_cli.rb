...
class TestCLI < Minitest::Test
  ...
  def test_control_clustered
    ...
    body = send_http_read_response "GET /stats HTTP/1.0\r\n\r\n", path: @tmp_path
  ...
  def test_control_stop
    ...
    body = send_http_read_response "GET /stop HTTP/1.0\r\n\r\n", path: @tmp_path
  ...
  def test_control_thread_backtraces
    ...
    body = send_http_read_response "GET /thread-backtraces HTTP/1.0\r\n\r\n", path: @tmp_path
