...
module Puma
  ...
  module Request
    ...
    LEN_BUFFER =   256 * 1_024
    LEN_1_MEG  = 1_024 * 1_024
    ...
    # and body segments (called by `fast_write_body`).
    ...
    def fast_write_body(io, body, strm, chunked)
      if body.is_a?(::File) || body.respond_to?(:read) || body.respond_to?(:readpartial)
        ...
        if body.first.is_a?(::String) && body.first.bytesize >= LEN_BUFFER
